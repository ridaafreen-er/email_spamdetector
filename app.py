...
if st.button("Check Spam"):
    email_clean = user_email.lower()
    email_clean = pd.Series(email_clean).str.replace(r'[^\w\s]', '', regex=True).iloc[0]
...
if st.button("Check Spam"):
    ...
    if prediction == 1:
        ...
        st.success("✅ This email is NOT SPAM")
>>>>>>> 13d7c9ea0fc0bb5ec258eb83182ed1ee5bb25aa6
